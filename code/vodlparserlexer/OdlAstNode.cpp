...
//-------------------------------------------------------------------------------
void TOdlAstNode::SetAsNamespaceTemplateInstanciation(TOdlAstNode* parIdentifier, TOdlAstNode* parTargetTemplateNamespaceIdentifierPointer, TOdlAstNode* parTemplateExpressionList)
{
    FAstNodeType = TOdlAstNodeType::NAMESPACE;
...
//-------------------------------------------------------------------------------
void TOdlAstNode::SetAsObjectTemplateDeclaration(TOdlAstNode* parIdentifier, TOdlAstNode* parTypeIdentifier, TOdlAstNode* parTemplateParameterList, TOdlAstNode* parPropertyList)
{
